...
// SPELLS    
        ...
        CardManager.AllCards.Add(new SpellCard("healing potion", "Sprites/Cards/healing-potion", 0, 3, SpellCard.SpellType.HEAL_ALLY_HERO, 2, SpellCard.TargetType.NO_TARGET));
